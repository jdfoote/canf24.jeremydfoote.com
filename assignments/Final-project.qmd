...
Due in Week 9. This is just a few paragraphs that explain:

- Which project type you are going to do
- Who will be in your group (if you are doing a group project)
- What you are planning to do for your project - what is the network
  you are going to study, what are the questions you are going to ask,
  etc.

### Rough Draft

Due November 26. This should be a complete draft of your project. You will turn this in on Brightspace, and also send it to your peers for feedback. You will be expected to provide feedback to your peers by the following Tuesday.

### Presentations

The last Thursday of class, we will have presentations. You will have 5 minutes to present your project to the class.

### Final Project

Due December 11. You will turn in your final project on Brightspace. This includes the .qmd file as well as a PDF of your report. Make sure to set `echo=FALSE` so that it doesn't include all of your code, and just looks like a nice report.